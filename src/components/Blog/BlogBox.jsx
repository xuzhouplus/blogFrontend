...
class BlogBox extends React.Component {
	render() {
		...
		return (
			<div className={gridItemClass} onClick={(event) => this.props.onClick(this.props.data, event)}>
				<img className="card-img-top img-fluid" src={this.props.data.thumbnail} alt={this.props.data.name}/>
				<div className="card-body">
					<h5 className="card-title" hidden={!this.props.data.name}>{this.props.data.name}</h5>
